...
class LoadStoryTestCase(unittest.TestCase):
    ...
    def _write_pages(self, pages: object) -> None:
        ...
        Args:
            pages: Value serialized as the book's `merged_pages.json` content.
        """
